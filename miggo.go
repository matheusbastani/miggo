...
func (m *Migrator) Create(name string, index ...int) {
	migrations.Create(m.baseDir, name, index...)
}
...
func (m *Migrator) Insert(name string, insertIndex int) {
	migrations.Insert(m.baseDir, name, insertIndex)
}
